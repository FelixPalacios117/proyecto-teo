...
tabla = [
    ...
    [E, 'aritmetico', None],
    [E, 'return', None],
    [EE,'llaveizq',['llaveizq']],
    [EE,'puntocoma',['puntocoma']],
    [EE, 'int', None],
    [EE, 'coma', None],
    [EE, 'float', None],
    [EE, 'char', None],
    ...
    [EE, 'logico', None],
    [EE, 'void', None],
    [EE, 'identificador', None],
    [EE, 'include', None],
    [EE, 'suma', None],
    [EE, 'resta', None],
    [EE, 'division', None],
    [EE, 'multiplicacion', None],
    [EE, 'aritmetico', None],
    [EE, 'return', None],
    # combinaciones del return
